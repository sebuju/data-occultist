// modern-screenshot v4.6.0 (https://github.com/qq15725/modern-screenshot) - MIT.
// Vendored single-file ESM bundle (offline; no build step). DOM -> image, clones live
// <canvas>/<img> to data URLs so window-preview canvases serialize. Used by the toolbox
// 'screenshot canvas' tool. Update by re-fetching dist/index.mjs at the pinned version.
