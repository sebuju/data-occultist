...
// group display order: pipeline windows sort by name within the tick-bucket slot (all pipeline ops
// share groupRank("tk")=0 so windows lead); op-buckets sort by their OP_GROUPS rank.
