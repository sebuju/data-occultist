...
def open_window(url: str, *, title: str = "data-rig", size: tuple[int, int] = (1400, 900)):
    ...
    # Title-bar / taskbar icon = the app favicon (static/favicon.ico, same artwork as
    # favicon.svg, generated by packaging/make_icon.py). Without this the window shows
    # the bare python/pythonw icon. Missing file -> pywebview's default, no crash.
